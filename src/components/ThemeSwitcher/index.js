          ...
          return (
            <div
              ...
              style={{
                ...
                borderRadius: "50%",
                boxShadow: `0px 0px 3px ${theme.shadowColorCode}`,
              }}
              onClick={() => {
...
const DarkIcon = ({ selectedTheme }) => (
  <svg
    ...
    viewBox="0 0 16 16"
    style={{ height: 24, width: 24, color: selectedTheme.modeColorCode }}
  >
...
//
export class Theme {
  constructor(mode, name, colorCode, shadowColorCode, modeColorCode) {
    this.mode = mode;
    this.name = name;
    this.colorCode = colorCode;
    this.shadowColorCode = shadowColorCode;
    this.modeColorCode = modeColorCode || colorCode;
  }
}
